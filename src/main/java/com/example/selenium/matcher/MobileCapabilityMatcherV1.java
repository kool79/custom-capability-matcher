...
public class MobileCapabilityMatcherV1 extends DefaultCapabilityMatcher {

	private static final Logger LOG = Logger.getLogger(MobileCapabilityMatcherV1.class.getName());
